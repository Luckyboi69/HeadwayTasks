...
class TestAdditiveTimeSeriesBuilder(unittest.TestCase):

    def setUp(self):
        self.builder = AdditiveTimeSeriesBuilder()
    ...
    def test_add_weekly_seasonality_exist(self):
        ...
        self.assertTrue(any(seasonal_component != 0))

    def test_add_daily_seasonality_exist(self):
        # Mock the data for the test
    ...
    def test_add_cycles_exist(self):
        # Mock the data for the test
